...
export default function HeroSection() {
  ...
  return (
    <section className="relative bg-gradient-to-r from-primary to-orange-500 text-white py-16 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              <a href="https://wa.me/79407442255" target="_blank" rel="noopener noreferrer">
      ...
      {/* Promotional banner */}
      <div className="absolute top-4 right-4 bg-accent text-white px-4 py-2 rounded-full font-semibold animate-pulse">
